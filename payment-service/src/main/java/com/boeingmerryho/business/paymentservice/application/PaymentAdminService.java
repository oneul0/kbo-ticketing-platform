...
public class PaymentAdminService {
	...
	public PaymentTicketRefundResponseServiceDto refundTicketPayment(
		...
		KakaoPayCancelRequest request = KakaoPayCancelRequest.builder()
			.cid(paymentDetail.getKakaoPayInfo().getCid())
			.tid(paymentDetail.getKakaoPayInfo().getTid())
			.cancelAmount(paymentDetail.getDiscountPrice())
			.cancelTaxFreeAmount(0)
			.build();

		KakaoPayCancelResponse response = kakaoFeignService.cancel(
